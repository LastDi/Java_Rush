    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                Long day1 = ((Date) stock1.get("date")).getTime() / day;
                Long day2 = ((Date) stock2.get("date")).getTime() / day;
                ...
                return (String.valueOf(stock1.get("name")).compareTo(String.valueOf(stock2.get("name"))));
            }
        });
    }
