...
public class Util {
    ...
    public static List<Jeans> getAllJeans() {
        abstract class AbstractJeans implements Jeans{
            ...
            public AbstractJeans(int id, int length, int size, double price) {this.id = id; this.size = size; this.length = length; this.price = price;}
            @Override
        ...
        class Denim extends AbstractJeans {
            public Denim(int id, int length, int size, double price) {super(id, length, size, price);}
            @Override
            public String getTM() {return Util.Company.Denim.fullName;}
        }
        class Levis extends AbstractJeans {
            public Levis(int id, int length, int size, double price) {super(id, length, size, price);}
            @Override
            public String getTM() {return Util.Company.Levis.fullName;}
        }
